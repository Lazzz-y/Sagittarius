...
-- ----------------------------
-- Sagittarius 系统 业务数据库
-- ----------------------------
CREATE DATABASE IF NOT EXISTS sagittarius_system DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_general_ci;

-- ----------------------------
-- Sagittarius 内容 业务数据库
-- ----------------------------
CREATE DATABASE IF NOT EXISTS sagittarius_article DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_general_ci;